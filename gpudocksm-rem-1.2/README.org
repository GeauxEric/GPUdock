...
**** TODO implement the setting of lowest temperature at run time
...
** DONE WTF is output_20131205_105456/a_XXXX.h5 ???
   to leave 4 digits
   
** TODO calculation of acceptance ratio added
   AR greater than 1.0 
** DONE check the temperature settings 

** TODO modify energy calculation if needed
   - [ ] implementation after the testings are done
   - result abtained from using /home/jaydy/work/dat/output/output/FF_opt/0.8.ff
...
** TODO enable argument parsing

*** TODO enable the modification of MAXTMP

*** TODO enable multiple types of recording 

** TODO WTF is cutil_yeah.h ???
   
   
    
** TODO why care about the mcs ??

** TODO record all the other replicas except for replica 0
** TODO 
