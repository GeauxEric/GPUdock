...
main (int argc, char **argv)
{
  ...
  */
  for(beta=0;beta<NBETA;beta++){
    ...
    printf("%1.7f\t",q1[beta]/SAMPLES/(rec_max-rec_start));
    printf("%1.7f\t",q2[beta]/SAMPLES/(rec_max-rec_start));
    printf("%1.7f\t",q3[beta]/SAMPLES/(rec_max-rec_start));
    printf("%1.7f\n",q4[beta]/SAMPLES/(rec_max-rec_start));
  }
