...
int main(int argc, char *argv[])
{
 ...
 for ( int in = 0; in < gpu_n; in++ )
 {
  ...
  cout << "Initial conformation:" << fixed << setprecision(4) << setw(12) << gpu_complex[in]->getEnergy(1) << endl;
  
  REMC( gpu_complex[in], remc_replicas, remc_steps, remc_cycles, step_t, step_r, boltzmann, false );
  
  gpu_complex[in]->setBest();
  
  cout << "Final conformation:  " << fixed << setprecision(4) << setw(12) << gpu_complex[in]->getEnergy(1) << endl;
  ...
  cout << "Function evaluations (total):   " << fixed << setprecision(0) << setw(10) << gpu_complex[in]->getFunctionEvals() << endl;
  cout << "Function evaluations (per sec): " << fixed << setprecision(0) << setw(10) << gpu_complex[in]->getFunctionEvals()/dif2 << endl;
 }
