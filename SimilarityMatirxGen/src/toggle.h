...
// CPU and MIC support has been dropped
// please alway select the GPU option 
#define USE_GPU 0
#define USE_CPU 1
#define USE_MIC 2
#define COMPUTE_DEVICE USE_GPU
...
// calculate docking
#define IS_CALCU_DOCK 0

// calculate similarity matrix
#define IS_CALCU_SIMILARITY_MATRIX 1
