...
class Complex {
  ...
  private:
    ...
    int _confusion_matrix[MAXLIG][MAXPRO];	    // confusion matrix descrbing the contacts of  the prt and lig points
...
//    double _complex_pmf[MAXTP1][MAXTP2][2]; // contact potential
  ...
  Complex( int, int );
    ...
    void calculateMccMtrx( void );


 
    void createConfusionMatrix( void );

    void clearConfusionMatrix( void );
